                ...
                <TableRow >
                    <TableCell style={{paddingBottom: 0, paddingTop: 0}} colSpan={6}>
                        <Collapse in={open} timeout="auto" unmountOnExit>
                            ...
                            {gameIdRow!==undefined?
                                <Box sx={{boxShadow:3, fontWeight: 'bold', borderRadius: 2, mt:2,mb:2,
                                ...
                                <Table  size="small" aria-label="users">
                                    <TableHead >
                                        <TableRow  >
                                            ...
                                            <TableCell align="center">{textTemplate.game.userGame.lastName}</TableCell>
                                    ...
                                    <TableBody>
                                        {gameIdRow.map((users) => (
                                            ...
                                            < TableRow
                                                ...
                                                <TableCell  align="center">{users.firstName===null?<FaceRetouchingOffIcon/>:
                                                users.firstName
                                                }</TableCell>
                                                </Tooltip>
                                                <TableCell align="center">{users.firstName===null?<FaceRetouchingOffIcon/>:
        ...
        return (
            ...
            <TableContainer sx={{mt:2,mb:2}}
                ...
                <Table
                    ...
                    <TableHead>
                        <TableRow   >
                            <TableCell sx={{fontWeight:"bold",maxWidth:3}}  align="left">{textTemplate.game.userGameTop}</TableCell>
                            <TableCell   sx={{fontWeight:"bold"}} align="center">{textTemplate.game.game_name}</TableCell>

                            <TableCell  sx={{fontWeight:"bold"}}  align="center">{textTemplate.game.game_start_date}</TableCell>
                            <TableCell sx={{fontWeight:"bold", maxWidth:5}} align="center">{textTemplate.game.isCompleted}</TableCell>
                            <TableCell sx={{fontWeight:"bold"}}  align="right">{textTemplate.game.admin_message}</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {rows.map((row) => (
