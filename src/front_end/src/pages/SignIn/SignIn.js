...
export default function SignIn() {
    ...
    function handleSubmit(event) {
        ...
        let formObjData;
        try {
            formObjData = convFormToObj(formData)
        } catch (error) {
            formObjData = defaultSignInData
        }
    ...
    return (
        <SmallTemplate maxWidth="xs">
            ...
            <Box sx={{width: "60%", justifyContent: "center", display: "grid", gap: 2}} component="form"
                 onChange={handleOnChange} container>
                ...
                <FormGroup>
                    <FormControlLabel control={<Checkbox defaultChecked/>} label={textTemplate.signin.terms}
